...
const LoginPage = () => {
   ...
   const { load, error, success, message, forgetErrorError, successWork, loadForget } = useSelector(
      (state) => state.auth,
   );
   ...
   }, [success, error, message, successWork, forgetErrorError, dispatch, navigate]);
