          ...
          {status === "public_offer" ? (
            <>
              ...
              >
                ПУБЛИЧНАЯ ОФЕРТА
                <span>
                  об условиях предоставления сервиса «Безопасная сделка» (далее
                  – ОФЕРТА)
                </span>
              </Typography>
              <Typography mt={1}>
                ...
                Пользователями Лига Услуг - http://ligauslug.ru/ <br /> Акцепт
              ...
              <Box>
                ...
                >
                  <span>Лига услуг - сайт</span>, приложение, представляющее
          ...
          {status === "terms_of_use" ? (
            <>
              ...
              <Box>
                ...
                <Typography mt={1}>
                  2.7. Сервис Лига Услуг –юридическое лицо, самостоятельно или
                ...
                >
                  3.1. Сервис Лига Услуг имеет право:
                  <span>
                    {" "}
          ...
          {status === "privacy_policy" ? (
            <>
              ...
              <Box>
                ...
                <Typography pl={4}>
                  Сервис услуг – сервис Лига услуг, доступный по адресу (
                  вставить адрес ) и на иных ресурсах, Условия – настоящие
                  Условия использования сервиса Лига услуг опубликованные по
                ...
                <Typography pl={4}>
                  Партнер – лицо, вступившее с Лига Услуг в договорные
                ...
                <Typography pl={4}>
                  ...
                  опубликована на странице Лига услуг и доступна неопределенному
                ...
                <Typography mt={2}>
                  1.2. Лига услуг предлагает любому пользователю использовать
                ...
                <Typography mt={2}>
                  1.4. Начиная использовать Лига услуг и его отдельные функции,
                ...
                <Typography>
                  ...
                  может быть заблокирован навсегда в сервисе Лига Услуг, без
                  предупреждения, или аннулирован.
                </Typography>
                <Typography mt={2}>
                  1.10. Лига услуг предоставляет зарегистрированному
                ...
                <Typography>
                  ...
                  выполнения требований законодательства, Лига Услуг хранит
                ...
                <Typography mt={2}>
                  1.12. Лига услуг может осуществлять проверку благонадежности
                  исполнителя основываясь на данных, предоставленных
                  исполнителем при создании аккаунта в Лига услуг. Проверка
                ...
                <Typography>
                  ...
                  предоставления документов, Лига услуг может отказать
                  исполнителю в предоставлении доступа к сайту Лига услуг, без
                  предоставления пояснений причин отказа.
                </Typography>
                <Typography mt={2}>
                  1.13. Пополняя личный счет исполнителя в Лига услуг,
                  поступившая денежная сумма, направляется на личный счет
                  исполнителя в Лига услуг и может быть использована для
                ...
                <Typography>
                  Лига услуг имеет возможность оценивать активность исполнителя,
                ...
                <Typography mt={2}>
                  1.14. Лига услуг предоставляет исполнителям откликаться на
                ...
                <Typography>
                  ...
                  выполненных заказов с использованием сервиса Лига услуг.
                </Typography>
                <Typography mt={2}>
                  1.15. Размещая карточку специалиста в сервисе Лига услуг,
                ...
                <Typography>
                  Лига услуг не может гарантировать, что данные сведения могут
                  ...
                  данные, пользователь соглашается на запись сервисом Лига услуг
                  разговора и номера телефона, с которого совершен звонок.
                  Записи звонков могут быть использованы в целях контроля
                  качества работы сервиса Лига услуг, рассмотрения жалоб
                ...
                <Typography mt={2}>
                  ...
                  Лига услуг, как на возмездной, так и на безвозмездной основе.
                </Typography>
                <Typography mt={2}>
                ...
                <Typography>
                  Запрещено использование сайта Лига услуг и его функций с целью
                ...
                <Typography>
                  Лига услуг оставляет за собой право без предупреждения и по
                ...
                <Typography mt={2}>
                  1.18. Лига услуг предоставляет всем пользователям бесплатную
                ...
                <Typography>
                  Услуги клиенту оказывает исполнитель с сайта Лига услуг, но
                  при этом Лига услуг не является участником отношений по
                ...
                <Typography>
                  Лига услуг рекомендует всем клиентам и кто ищет специалистов
                  через Лига услуг, после выбора специалиста, не вносить не
                  ...
                  сторонами напрямую без участия Лига услуг.
                </Typography>
                <Typography mt={2}>
                  1.19. Указанная информация об услугах, условиях и стоимости их
                  оказания, указанная на сайте Лига услуг, носит справочный
                ...
                <Typography>
                  Лига услуг не может гарантировать 100% соответствия сайта
                ...
                <Typography>
                  Лига услуг не является участником правоотношений,
                ...
                <Typography mt={2}>
                  1.20. Лига услуг оставляет за собой право на свое усмотрение
                ...
                <Typography>
                  Лига услуг оставляет за собой право ограничить доступ клиента
                  к сайту или заблокировать профиль клиента на сайте в случае
                  выявления подозрительных действий на сайте.
                </Typography>
                <Typography>
                  Любая информация, используемая на сайте Лига услуг,
                ...
                <Typography>
                  ...
                  использования сайта Лига услуг, а также с возможным нарушением
                  законодательства или прав третьих лиц на сайте Лига услуг,
