...
import { askQuestion, leaveNumber } from '../../../store/actions/MessageActions';
import { selectMessage, setMessage } from '../../../store/reducers/MessagingReducer';
   ...
   return (
      <Box sx={CONTAINER_STYLE}>
         <Box>
            ...
            />
            {errors?.message?.message && <Box sx={ER_MESSAGE}>{errors?.message?.message}</Box>}
         </Box>
         <Box>
            <TextField
               multiline
            ...
            />
            {errors?.email?.message && <Box sx={ER_MESSAGE}>{errors?.email?.message}</Box>}
         </Box>
         <Box
            sx={{
               margin: '0 auto',
        ...
        /> */}
         ...
         <Box sx={ITEM_STYLE}>
            <TextField
               ...
               placeholder="Անուն"
            />
            {errors.name?.message && <Box sx={ER_MESSAGE}>{errors.name.message}</Box>}
         </Box>
         <Box sx={ITEM_STYLE}>
            <BasicDatePicker
               ...
               value={dateValue}
            />
            {errors.date?.message && <Box sx={ER_MESSAGE}>{errors.date.message}</Box>}
         </Box>
         <Box sx={ITEM_STYLE}>
            <BasicTimePicker
            ...
            />
            {errors.time?.message && <Box sx={ER_MESSAGE}>{errors.time.message}</Box>}
         </Box>
